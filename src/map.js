...
const afficherMap = () => {
  ...
  div.classList.add("mapDiv");
  div.innerHTML = `
  <h1 class="mapTitle" id="title"  style="color: #e4004d;">L'amour à travers le monde</h1>
  <div class="italie-txt hide">
            <h1 id="title">Italie</h1>
            <p>
              les couples posent des cadenas d'amour sur les parapets des ponts
              le jour de la Saint-Valentin. Les cadenas sont marqués d'un nom et
              la clé est ensuite jetée dans l'eau. L'amour est ainsi censé durer
              éternellement. Une autre tradition italienne encourageait les
              jeunes filles célibataires à se réveiller tôt : on disait que le
              premier homme aperçu avant l’aube deviendrait leur mari dans
              l’année.
            </p>
          </div>

          <div class="philippines-txt hide">
            <h1 id="title">Philippines</h1>
            <p>
              Des milliers de couples se rejoignent aux abords de la baie de
              Manille et, à minuit, tous ces couples s’embrassent et gardent les
              lèvres jointes pendant plusieurs secondes. Aux Philippines, la
              Saint-Valentin est également l’occasion pour beaucoup de couples
              de se marier gratuitement en profitant des « mariages de masse »
              organisés par certaines églises et divers organismes
              gouvernementaux.
            </p>
          </div>

          <div class="argentine-txt hide">
            <h1 id="title">Argentine</h1>
            <p>
              Pour les Argentins, cette journée spéciale de février n’est que le
              précurseur d’une célébration bien plus longue, connue sous le nom
              de « Semaine de la douceur« . La Semaine de la douceur, qui n’est
              née qu’en 1989, a lieu en juillet. Pendant la Semaine de la
              douceur, les amis et les amoureux échangent des baisers et des
              bonbons. Les festivités se terminent par le «jour de l’amitié»,
              lorsque les relations amicales de toutes sortes sont célébrées et
              appréciées.
            </p>
          </div>

          <div class="mexique-txt hide">
            <h1 id="title">Mexique</h1>
            <p>
              Au Mexique, la Saint-Valentin est célébrée non seulement comme une
              journée d'amour entre les couples, mais aussi comme une journée de
              l'amitié. C'est l'occasion pour les gens d'échanger des cadeaux et
              des cartes avec leurs amis proches ainsi qu'avec leurs partenaires
              romantiques.
            </p>
          </div>

          <div class="danemark-txt hide">
            <h1 id="title">Danemark</h1>
            <p>
              Les jeunes Danois offrent des fleurs printanières appelées
              perce-neige avec des notes anonymes appelées « gaekkebrev. » Si
              leur destinataire devine correctement qui a envoyé la note, ils
              reçoivent un œuf de Pâques en bonbon à la fête de Pâques.
            </p>
          </div>

          <div class="afriqueSud-txt hide">
            <h1 id="title">Afrique du Sud</h1>
            <p>
              À ce jour, les femmes d’Afrique du Sud suivent toujours cette
              ancienne tradition romaine de Lupercalia qui a tout déclenché. À
              l’occasion de la Lupercalia, de nombreuses femmes sud-africaines
              se munissent d’un stylo et de papier, pour écrire le nom de la
              personne qui les intéresse et l’épingler à leur manche. Bien plus
              direct qu’une lettre d’amour!
            </p>
          </div>

          <div class="inde-txt hide">
            <h1 id="title">Inde</h1>
            <p>
              En Inde, la Saint-Valentin est devenue de plus en plus populaire,
              surtout parmi la jeune génération urbaine. Cependant, la
              Saint-Valentin a également suscité des controverses dans certaines
              régions où des groupes conservateurs ont protesté contre la
              "culture occidentale".
            </p>
          </div>

          <div class="japon-txt hide">
            <h1 id="title">Japon</h1>
            <p>
              Alors que dans les pays occidentaux, les cadeaux sont plutôt
              offerts par les hommes, au Japon, ce sont surtout les femmes qui
              offrent des cadeaux à leurs proches. Traditionnellement, on y
              offre du chocolat noir aux partenaires, mais aussi aux amis, à la
              famille et aux collègues de travail.
            </p>
          </div>

          <div class="suede-txt hide">
            <h1 id="title">Suède</h1>
            <p>
              La Saint-Valentin est appelée «le jour de tous les cœurs» et on y
              offre traditionnellement des cœurs rouges en gomme au vin.
            </p>
          </div>

          <div class="finlande-txt hide">
            <h1 id="title">Finlande</h1>
            <p>
              Le 14 février est délibérément fêté comme la journée de l'amitié.
              Comme nous l'avons dit, l'amour a de multiples facettes.
            </p>
          </div>

          <div class="ethiopie-txt hide">
            <h1 id="title">Ethiopie</h1>
            <p>
              En Éthiopie, la Saint-Valentin, ou "Yekatit 23", est célébrée le
              23 février. C'est une journée où les couples se réunissent pour
              célébrer leur amour, mais c'est aussi une journée de commémoration
              des martyrs qui ont perdu leur vie dans la lutte contre la
              dictature du Derg en 1974.
            </p>
          </div>

          <div class="bresil-txt hide">
            <h1 id="title">Brésil</h1>
            <p>
              Au Brésil, la Saint-Valentin, ou "Dia dos Namorados", est célébrée
              le 12 juin, la veille de la fête de Saint-Antoine, le saint patron
              des couples et des mariages.
            </p>
          </div>

          <div class="coreeSud-txt hide">
            <h1 id="title">Corée du Sud</h1>
            <p>
              En Corée du Sud, la Saint-Valentin est une fête qui dure trois
              jours. Le 14 février, les femmes offrent des chocolats aux hommes,
              puis le 14 mars, appelé "White Day", les hommes retournent les
              faveurs en offrant des cadeaux aux femmes. Enfin, le 14 avril,
              appelé "Black Day", est une journée où les célibataires se
              réunissent pour manger du jjajangmyeon, un plat de nouilles aux
              haricots noirs.
            </p>
          </div>

          <div class="france-txt hide">
            <h1 id="title">France</h1>
            <p>
              La France, souvent considérée comme le pays de l'amour, célèbre la
              Saint-Valentin de manière similaire à de nombreux autres pays,
              avec des échanges de cadeaux, de dîners romantiques et de fleurs.
              Paris, en particulier, est réputée pour ses atmosphères
              romantiques le jour de la Saint-Valentin, avec des couples se
              promenant le long de la Seine et visitant des sites emblématiques
          ...
          <svg
            ...
            viewBox="150 50 1000 700"
            width="850px"
            style="stroke: 5px #e4004d;"
          >
            ...
            <g id="sFFT8b.tif">
              ...
              <path
                class="cls-1"
                d="M413.79,910.44c0-.8,0-1.26,0-1.71.08-1.18.18-2.37.28-3.55a25.06,25.06,0,0,0-4.73-.15,5.61,5.61,0,0,0-2.42,1.68c-1.75,1.61-3.45.76-5-.17s-1.43-2.57.33-3.23a35.36,35.36,0,0,1,5.24-1.54c2.2-.46,3.28-1.61,3.92-3.85s.72-3.69-1.64-4.87a6.33,6.33,0,0,1-2.5-2.91c-.4-.86-.1-2-.11-3.07a12.4,12.4,0,0,1,3.67.14c.82.28,1.39,1.36,2,2.13q3.42,4.29,6.78,8.61c2.87,3.7,2.2,8.15-1.66,11a6.84,6.84,0,0,1-1.76.91A24.46,24.46,0,0,1,413.79,910.44Z"
                transform="translate(-2.5 -96.22)"
              />
              <path
                class="cls-1"
              ...
              <path
                class="cls-1"
                d="
z"
                transform="translate(-2.5 -96.22)"
              />
              <path
                class="cls-1"
              ...
              <path
                class="cls-1"
                d="M444.41,849.19c-.58-.86-1.2-1.38-1.12-1.74a5.7,5.7,0,0,1,1.14-1.7c.46.38,1.33.82,1.28,1.12A8.48,8.48,0,0,1,444.41,849.19Z"
                transform="translate(-2.5 -96.22)"
              />
              <path
                class="cls-1"
              ...
              <path
                class="cls-1"
                d="M555.89,500.23h-5.68V500h5.68Z"
                transform="translate(-2.5 -96.22)"
              />
              <path
                class="cls-1"
                d="M555.37,497.26h-5.44V497l5.78-.33Z"
                transform="translate(-2.5 -96.22)"
              />
              <path
                class="cls-1"
                d="M327.18,435.16,329,438l-1,.65-1.91-2.82Z"
                transform="translate(-2.5 -96.22)"
              />
              <path
                class="cls-1"
                d="M331.71,446.25c-2.46.37-2.68-1-2.86-2.3,0-.11.16-.26.25-.39Z"
                transform="translate(-2.5 -96.22)"
              />
              <path
                class="cls-1"
            ...
            <circle class="cls-2 marker-italie" cx="652" cy="280" r="5.5" />
            <circle class="cls-2 marker-danemark" cx="640" cy="212" r="5.5" />
            <circle
              class="cls-2 marker-philippines"
              cx="1070"
              cy="400"
              r="5.5"
            />
            <circle class="cls-2 marker-afriqueSud" cx="700" cy="575" r="5.5" />
            <circle class="cls-2 marker-argentine" cx="374" cy="604" r="5.5" />
            <circle class="cls-2 marker-japon" cx="1104" cy="270" r="5.5" />
            <circle class="cls-2 marker-suede" cx="657" cy="170" r="5.5" />
            <circle class="cls-2 marker-finlande" cx="690" cy="160" r="5.5" />
            <circle class="cls-2 marker-bresil" cx="420" cy="500" r="5.5" />
            <circle class="cls-2 marker-france" cx="618" cy="260" r="5.5" />
            <circle class="cls-2 marker-coreeSud" cx="1062" cy="276" r="5.5" />
            <circle class="cls-2 marker-mexique" cx="230" cy="350" r="5.5" />
            <circle class="cls-2 marker-inde" cx="900" cy="360" r="5.5" />
            <circle class="cls-2 marker-ethiopie" cx="760" cy="420" r="5.5" />
          </svg>
  `;
  blocHorizontal.appendChild(div);
};

document.addEventListener("DOMContentLoaded", function () {
  // Function to hide all elements with the class 'hide'
  document.querySelectorAll(".hide").forEach((element) => {
    element.style.display = "none";
  });

  // Function to handle mouse enter and leave events
  function setupHoverHandlers(markerClass, textClass) {
    const markers = document.querySelectorAll(markerClass);
    markers.forEach((marker) => {
      marker.addEventListener("mouseenter", () => {
        const textElement = document.querySelector(textClass);
        textElement.style.display = "block"; // Use 'block' instead of 'none' to show the text
      });
  ...
  // Setup hover handlers for each country
  setupHoverHandlers(".marker-italie", ".italie-txt");
  setupHoverHandlers(".marker-philippines", ".philippines-txt");
  setupHoverHandlers(".marker-argentine", ".argentine-txt");
  setupHoverHandlers(".marker-mexique", ".mexique-txt");
  setupHoverHandlers(".marker-danemark", ".danemark-txt");
  setupHoverHandlers(".marker-afriqueSud", ".afriqueSud-txt");
  setupHoverHandlers(".marker-inde", ".inde-txt");
  setupHoverHandlers(".marker-japon", ".japon-txt");
  setupHoverHandlers(".marker-suede", ".suede-txt");
  setupHoverHandlers(".marker-finlande", ".finlande-txt");
  setupHoverHandlers(".marker-ethiopie", ".ethiopie-txt");
  setupHoverHandlers(".marker-bresil", ".bresil-txt");
  setupHoverHandlers(".marker-coreeSud", ".coreeSud-txt");
  setupHoverHandlers(".marker-france", ".france-txt");
});
